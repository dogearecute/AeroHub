...
function VLib:Window(textgame)
	...
	CircleName.Image = "rbxassetid://138664846452607"
	...
	function Tabs:Tab(image, text)
		...
		Image.Position = UDim2.new(0.0566037744, 0, 0, 0)  
		...
		Title.Position = UDim2.new(0.0566037744 + 0.185, 0, 0, 0)  
